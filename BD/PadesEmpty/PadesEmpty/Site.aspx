...
<form id="form1" runat="server">
   ...
   <div id="SiteHeader">
       <div id="SiteLogo">
           <img src="Image/Pades8.png" alt="Logo" />
       ...
       <div id="SiteNavigation">
           ...
           <input type="button" id="BtnLog" value="Вход" onclick="Login()"/>
...
<br />
      ...
      <%-- <asp:Button ID="Login" runat="server" Height="37px" Text="Вход" Width="25px" />--%>
       <div id="UserLogin">
           ...
           <br />
           <br />
           <asp:Button ID="BtnLogin" runat="server" Text="Войти" OnClick="UserEnter"/>
       </div>
       <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SiteCatalogConnectionString3 %>" DeleteCommand="DELETE FROM [Product] WHERE [IDProduct] = @IDProduct" InsertCommand="INSERT INTO [Product] ([ProductName], [Discription], [FullDiscription], [IDPhoto]) VALUES (@ProductName, @Discription, @FullDiscription, @IDPhoto)" SelectCommand="SELECT Product.ProductName, Product.Discription, Category.CategoryName, Category.IDCategory, Product.IDProduct FROM Category INNER JOIN ProductCategory ON Category.IDCategory = ProductCategory.IDCategory INNER JOIN Product ON ProductCategory.IDProduct = Product.IDProduct WHERE (Category.CategoryName = @CategoryName)" UpdateCommand="UPDATE [Product] SET [ProductName] = @ProductName, [Discription] = @Discription, [FullDiscription] = @FullDiscription, [IDPhoto] = @IDPhoto WHERE [IDProduct] = @IDProduct">
           <DeleteParameters>
...
&nbsp;&nbsp;&nbsp;
    ...
    <div id="SiteFooterBottom">
        ...
        <div id="SiteFooterBottomText">
        <p>Copyright @ 2013 </p><ul><li>PADES</li><li>Help</li><li>Support</li><li>Info</li></ul>
