...
<form id="form1" runat="server">
   ...
   <div id="Page">
       ...
       <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SiteCatalogConnectionString %>" DeleteCommand="DELETE FROM [Comments] WHERE [IDUser] = @IDUser
DELETE FROM [User] WHERE [IDUser] = @IDUser" InsertCommand="INSERT INTO [User] ([UserName], [UserPassword], [UserStatus]) VALUES (@UserName, @UserPassword, @UserStatus)" ProviderName="<%$ ConnectionStrings:SiteCatalogConnectionString.ProviderName %>" SelectCommand="SELECT [IDUser], [UserName], [UserPassword], [UserStatus] FROM [User]" UpdateCommand="UPDATE [User] SET [UserName] = @UserName, [UserPassword] = @UserPassword, [UserStatus] = @UserStatus WHERE [IDUser] = @IDUser">
           <DeleteParameters>
