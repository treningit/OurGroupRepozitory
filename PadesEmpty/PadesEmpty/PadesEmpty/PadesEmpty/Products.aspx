<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Products.aspx.cs" Inherits="PadesEmpty.Products" %>
   ...
   <div id="Page">
       <div id="Menu" >
        ...
        <div id="Content" >
            ...
            <div id="Section">
                <p id="TextFromButton" runat="server">Товары</p>
                <hr style="background-color: #FFFFFF; height: 3px;" /> 
                <p>
                <asp:Button ID="Button1" runat="server" Text="Добавить товар" OnClick="Button1_Click" />
                </p>
...
&nbsp;<asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="IDProduct" DataSourceID="SqlDataSource2" EmptyDataText="There are no data records to display." ForeColor="#333333" GridLines="None" PageSize="5" Width="708px" AllowPaging="True">
