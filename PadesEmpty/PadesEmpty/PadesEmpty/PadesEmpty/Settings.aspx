<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Settings.aspx.cs" Inherits="PadesEmpty.Settings" %>
...
&nbsp;<asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="IDProduct" DataSourceID="SqlDataSource2" EmptyDataText="There are no data records to display." ForeColor="#333333" GridLines="None" PageSize="5" Visible="False" Width="708px" AllowPaging="True">
                    <AlternatingRowStyle BackColor="White" />
                    <Columns>
                        <asp:BoundField DataField="IDProduct" HeaderText="IDProduct" SortExpression="IDProduct" ReadOnly="True" />
                        ...
                        <asp:BoundField DataField="IDPhoto" HeaderText="IDPhoto" SortExpression="IDPhoto" />
                    </Columns>
                ...
                <br />
                <br />
                <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:SiteCatalogConnectionString3 %>" DeleteCommand="DELETE FROM [Comments] WHERE [IDProduct] = @IDProduct
...
<asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="IDCategory" DataSourceID="SqlDataSource1" EmptyDataText="There are no data records to display." ForeColor="#333333" GridLines="None" AllowPaging="True" AllowSorting="True" PageSize="5" Visible="False" Width="705px">
       ...
       <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SiteCatalogConnectionString3 %>" DeleteCommand="DELETE FROM [ProductCategory] WHERE [IDCategory] = @IDCategory
DELETE FROM [Category] WHERE [IDCategory] = @IDCategory" InsertCommand="INSERT INTO [Category] ([IDCategory], [CategoryName]) VALUES (@IDCategory, @CategoryName)" SelectCommand="SELECT [IDCategory], [CategoryName] FROM [Category]" UpdateCommand="UPDATE [Category] SET [CategoryName] = @CategoryName WHERE [IDCategory] = @IDCategory">
           <DeleteParameters>
